...
def search_uniprot_go(organism, go_term):
    try:
        ...
        # GO ID mi yoksa terim mi?
        is_go_id = bool(re.match(r"GO:\d+", go_clean, re.IGNORECASE))
        
        if is_go_id:
            # GO:0050053 -> 0050053 (UniProt API prefix kabul etmiyor)
        ...
        params = {
            ...
            "format": "json",
            "size": "25",
            "fields": "accession,protein_name,gene_names,organism_name,go_p,go_f,go_c"
        }
        ...
        for entry in data.get("results", []):
            ...
            # GO annotations - yeni UniProt API formatı
            go_terms = []
